...
file_name = "/dataspace/sandeep/Bispectrum_data/Gaussian_60K_test/plots/3sigma_table.txt"
with open(file_name, 'w') as f:
    f.write("delta\tI1\tI2\tI3\n")
    ...
    def plot_data(count1):
        ...
        for ii in xrange(len(I3)):
            if I3[ii] == count1:
                index, index1 = I1[ii], I2[ii]
                data[index, index1] = (Bis1[ii]-mean[ii])/std_dev[ii]
                if (Bis1[ii]-mean[ii])/std_dev[ii] >3.0:
                    f.write("I3 Bin %d\n" % I3[ii])
                    f.write("%0.6e\t%d\t%d\t%d\n" % ((Bis1[ii]-mean[ii])/std_dev[ii], I1[ii], I2[ii], I3[ii]))
                    f.write("\n")
    ...
    gs = gridspec.GridSpec(4, 3, left=0.05, hspace=0.5, wspace=0.4)
    ...
    plt.savefig("/dataspace/sandeep/Bispectrum_data/Gaussian_60K_test/plots/Allmode_2dplot_Bin_Bispectrum_nbin-11.png", dpi=600)
#plt.savefig('/dataspace/sandeep/Bispectrum_data/test.png', dpi=600)
...
plt.savefig('/dataspace/sandeep/Bispectrum_data/Gaussian_60K_test/plots/Allmode_Bin_Bispectrum_lll_nbin-11.png', dpi=600)
plt.show()
