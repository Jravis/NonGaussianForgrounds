...
#s2 = '/Gaussian_30K_test/Gaussian_30K_Maps/haslam_30KgaussMap_10.fits'
...
for indX in xrange(0, 4):
    for indY in xrange(0, 3):
        ...
        ax1.set_title(r'30K Haslam ($I_{%d}$)' % (i+1))
...
#plt.savefig("/dataspace/sandeep/Bispectrum_data/Gaussian_30K_test/alm_30K_stat/GaussianMap_Bin_Imag_alm_log.eps",
#            dpi=100)
plt.savefig("/dataspace/sandeep/Bispectrum_data/Gaussian_30K_test/alm_30K_stat/ActualMap_Bin_real_alm_log.eps",
            dpi=100)
plt.show()